 ...
 *
 *      $logger = new \Monolog\Logger('all', array(new \Monolog\Service\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    /**
     * @param  array<string, mixed> $options   See \Monolog\Service\PHPConsoleHandler::$options for more details
